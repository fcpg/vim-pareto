...
" PRIMITIVES
call s:HL('Boolean',        s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Character',      s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Constant',       s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Float',          s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Number',         s:palette.gray12,  s:palette.black,  'bold')
call s:HL('String',         s:palette.gray14,  s:palette.black,  'none')
call s:HL('SpecialChar',    s:palette.purple,  s:palette.black,  'none')

" COMMENTS
call s:HL('Comment',        s:palette.gray10,  s:palette.black,  'bold')
call s:HL('SpecialComment', s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Title',          s:palette.gray12,  s:palette.black,  'bold')
call s:HL('Todo',           s:palette.orange,  s:palette.black,  'bold')

" LINES, COLUMNS
call s:HL('LineNr',         s:palette.gray09,  s:palette.black,  'bold')
call s:HL('CursorLine',     s:palette.white,   s:palette.gray03, 'none')
call s:HL('CursorLineNr',   s:palette.gray11,  s:palette.black,  'bold')
...
call s:HL('Underlined',     s:palette.gray14,  s:palette.black,  'underline')
call s:HL('SpecialKey',     s:palette.white,   s:palette.black,  'bold')
call s:HL('NonText',        s:palette.darkred, s:palette.black,  'bold')
call s:HL('Directory',      s:palette.orange,  s:palette.black,  'none')

" FOLD
call s:HL('FoldColumn',     s:palette.gray10,  s:palette.black,  'bold')
call s:HL('Folded',         s:palette.gray10,  s:palette.black,  'bold')
